...
exports.bufferUploadExample = bufferUploadExample;
exports.nearIntegrationExample = nearIntegrationExample;
...
async function exampleUsage() {
    ...
    const uploader = (0, upload_1.createAutoDriveUploader)(apiKey, auto_utils_1.NetworkId.TAURUS);
    ...
    try {
        ...
        const result = await uploader.uploadFileFromPath('./example-file.txt', uploadOptions);
...
async function bufferUploadExample() {
    ...
    try {
        ...
        const result = await uploader.uploadFileFromBuffer(fileBuffer, 'example-file.txt', uploadOptions);
